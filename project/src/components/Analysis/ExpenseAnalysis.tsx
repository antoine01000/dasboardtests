...
import { ArrowUpRight, ArrowDownRight, TrendingUp, Users, Tags, Filter, X, ChevronDown, ChevronUp, Search } from 'lucide-react';
...
export const ExpenseAnalysis: React.FC = () => {
  ...
  // Calcul de la dépense moyenne par transaction
  const depenseMoyenne = useMemo(() => {
    return filteredExpenses.length > 0 ? totalDepense / filteredExpenses.length : 0;
  }, [totalDepense, filteredExpenses]);
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Encart KPI : Dépense Moyenne par Transaction */}
      <section className="bg-white p-6 rounded-lg shadow-lg mb-6">
        ...
        <p className="text-sm text-gray-600 mt-2">
          Moyenne calculée sur {filteredExpenses.length} transaction{filteredExpenses.length > 1 ? 's' : ''}.
        </p>
      </section>
